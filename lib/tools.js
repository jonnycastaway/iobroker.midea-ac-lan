...
class MideaAC {
    ...
    handleData(data) {
        ...
        while (this.buffer.length >= 8) {
            ...
            this.log.info(`[${this.deviceId}] Decrypt result: ${typeof result}, ${result ? (result.hex ? result.hex().substring(0,40) : result.substring(0,40)) : 'null'}`);
    ...
    sendApplianceQuery() {
        ...
        const header = Buffer.from([0xAA, 0x1D, DEVICE_TYPE_AC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA0]);
