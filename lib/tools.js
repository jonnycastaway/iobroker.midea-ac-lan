...
class MideaProtocol {
    ...
    calculateTcpKey(responseData) {
        this.log.info(`[${this.deviceId}] calculateTcpKey: key=${this.key.toString('hex').slice(0,32)}...`);
        ...
        try {
            ...
            this.log.info(`[${this.deviceId}] Plain: ${plain.toString('hex').slice(0,32)}...`);
            ...
            if (!match) {
                this.log.warn(`[${this.deviceId}] Signature mismatch!`);
                return null;
            }
