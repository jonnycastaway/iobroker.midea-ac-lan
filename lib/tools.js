...
initTcpKey(response, key) {
        try {
            ...
            this.adapter.log.info('=== DEBUG payload=' + payload.toString('hex').substring(0, 32));
            ...
            try {
                ...
                this.adapter.log.info('=== DEBUG aes result=' + plain.toString('hex').substring(0, 32));
            } catch(e) {
                this.adapter.log.error('=== AES error: ' + e.message);
                throw e;
            }
