...
class MideaAdapter {
    ...
    buildMsmartQuery() {
        ...
        // This is sent directly after TCP handshake (not wrapped in 0x8370)
        ...
        const payloadCrc = this.crc8(payloadWithId);
        const payloadWithCrc = Buffer.concat([payloadWithId, Buffer.from([payloadCrc])]);
