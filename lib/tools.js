...
class MideaProtocol {
    ...
    calculateTcpKey(responseData) {
        // responseData is 64 bytes: first 32 = encrypted, last 32 = signature
        // We need to decrypt first 32 bytes with key, then XOR result with key
        ...
        // XOR plain with key to get tcpKey
        const tcpKey = Buffer.alloc(64);
        for (let i = 0; i < 32; i++) {
