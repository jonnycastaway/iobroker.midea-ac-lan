...
class MideaAdapter {
    ...
    buildV3Query(device) {
        // Python's MessageQueryAppliance format:
        # body: aa 1e ac 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 checksum
        # Das ist: flag(AA) + length(1E) + type(AC) + 26 bytes zeros + checksum
